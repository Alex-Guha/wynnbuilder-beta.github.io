...
const SANDBOX_FILES = [
    ...
    'js/solver/engine/priority/helpers.js',
    'js/solver/engine/priority/sensitivity_baseline.js',
    'js/solver/engine/priority/sensitivity.js',
    'js/solver/engine/priority/priority.js',
    'js/solver/engine/priority/dominance.js',
    'js/game/build.js',
