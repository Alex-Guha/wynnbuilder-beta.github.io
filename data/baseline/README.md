...
| `recipes.json` | Raw recipe data | Hand (or from `get.py recipes`) |
...
All other intermediate artifacts (`item_out.json`, `ing_out.json`, `tome_out.json`, `aspects_min.json`, `atree_constants_min.json`, `major_ids_min.json`, `dps_data.json`, `atree_ids.json`, `encoding_consts.json`, etc.) land in `data/temp/`.
...
# 5. Manually review data/temp/ outputs and update data/baseline/ files
#    (aspects.json, major_ids_clean.json, atree_constants.json) as needed
#    by copying approved changes from data/temp/ into data/baseline/.

# 6. Compile/minify atree, major IDs, aspects — writes to data/temp/
python3 atree-generateID.py

# 7. Generate DPS data — writes data/temp/dps_data.json
...
python3 compress_json.py ../data/temp/item_out.json        ../data/$VER/items.json
python3 compress_json.py ../data/temp/item_out.json        ../data/baseline/compressed/compress.json
python3 compress_json.py ../data/temp/ing_out.json         ../data/$VER/ingreds.json
python3 compress_json.py ../data/temp/tome_out.json        ../data/$VER/tomes.json
python3 compress_json.py ../data/temp/recipes_clean.json   ../data/$VER/recipes.json
cp ../data/temp/dps_data.json ../data/$VER/dps_data.json
